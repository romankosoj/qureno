...
Qureno Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9779.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9798 for connections and services them.
...
However, in open source software such as Qureno Core, where everyone uses
...
pay attention to for reviewers of Qureno Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Qureno Core uses tinyformat, which is type safe. Leave them out to avoid confusion
