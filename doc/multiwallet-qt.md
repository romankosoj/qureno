...
Only requiring some minor changes is qureno.cpp.
...
Changes to qureno.cpp
----------------------
qureno.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
