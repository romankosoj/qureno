...
This mechanism has been integrated into Bitcore-Node-Qureno which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qureno/insight-api-qureno#web-socket-api](https://github.com/qureno/insight-api-qureno#web-socket-api)
* API: [https://github.com/qureno/insight-api-qureno#instantsend-transactions](https://github.com/qureno/insight-api-qureno#instantsend-transactions)
...
By default, the Qureno Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qureno Core daemon:
