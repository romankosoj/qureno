...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Qureno related functionality
...
/*
    ...
    allow endless transaction that would bloat Qureno and make it unusable. To
