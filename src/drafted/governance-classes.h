 ...
 *
 *   // network
 *   CQurenoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CQurenoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QurenoNetwork
// //   -- signature requirements : Key1(User)
// class CQurenoNetworkVariable : public CGovernanceObject
// {
// private:
