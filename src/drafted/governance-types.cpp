...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QurenoNetwork") type = QurenoNetwork;
    if(strType == "QurenoNetworkVariable") type = QurenoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QurenoNetwork) s = "QurenoNetwork";
    if(type == QurenoNetworkVariable) s = "QurenoNetworkVariable";
