...
#define BOOST_TEST_MODULE Qureno Test Suite

#include "test_qureno.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_qureno_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
