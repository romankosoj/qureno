...
{
private:
    // critical section to qureno the inner data structures
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 QRN - checking if valid masternode)
