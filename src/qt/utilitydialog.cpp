    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Qureno Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Qureno Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  qureno-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Qureno in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QRN, 0.1 QRN, 1 QRN and 10 QRN -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Qureno Core is shutting down...") + "<br /><br />" +
