    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Qureno Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Qureno address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qureno: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Qureno Core"), this);
    aboutAction->setStatusTip(tr("Show information about Qureno Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qureno Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Qureno addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Qureno addresses"));
    ...
    openAction->setStatusTip(tr("Open a qureno: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Qureno Core help message to get a list with possible Qureno Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Qureno Core client") + " " + networkStyle->getTitleAddText();
...
{
    //QString theme = GUIUtil::getThemeName();
    //overviewAction->setIcon(QIcon(":/icons/" + theme + "/overview"));
    overviewAction->setChecked(true);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Qureno network", "", count));
    } else {
...
{
    QString strTitle = tr("Qureno Core"); // default title
